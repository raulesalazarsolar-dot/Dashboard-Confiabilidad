...
/* NUEVOS ESTILOS PARA TEAM BRANDING */
.team-branding { margin-top: 30px; text-align: center; display: flex; flex-direction: column; align-items: center; gap: 8px; }
.team-branding img { max-width: 140px; height: auto; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.1)); }
.team-branding p { font-size: 0.75rem; font-weight: 800; color: var(--primary); text-transform: uppercase; letter-spacing: 0.5px; margin: 0; opacity: 0.9; }
  ...
  <div class="sidebar">
    ...
    <div style="padding:20px;border-top:1px solid var(--border);">
      ...
      <div class="team-branding">
          <img src="avatar_ways.png" alt="Ways 2026" onerror="this.style.display='none'">
          <p>Equipo de Planificación Ways 2026</p>
      </div>
...
function renderResumen() {
  ...
  Object.keys(lnByPlanta).sort().forEach(planta => {
    ...
    // LIMITAR A TOP 3 CON REGLAS DE EXCLUSIÓN
    const top3 = eqs.map(e => {
      ...
      return { ...e, prob, mtbf, mttr, probPrev, mtbfPrev };
        ...
        // Excluir equipos sin detenciones
        ...
        // Exclusión específica para Top 3 en Masas
        if (esMasas && eqStr === '0') return false;
        
        // Exclusión específica para Top 3 en Carnes
